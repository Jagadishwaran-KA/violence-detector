...
function Layout() {
  ...
  const processVideo = async (e) => {
    e.preventDefault();
    const file_name = e.target.something.files[0].name;
    isLoading(true);
    await new Promise((r) => setTimeout(r, 15000));
    isLoading(false);
    setFilename(`./src/assets/outputs/${file_name}`);
  };
          ...
          <div>
            ...
            <div>
              <p className="w-4/5 mt-2 text-gray-300">
                Empowering Safe Content: Upload and Ensure Violence-Free Videos
                with our AI-Powered Detection System.
              </p>
              <div className="border-dotted border-2 border-spacing-12 rounded-md p-2 mt-12 border-gray-500 w-80  h-56">
                ...
                <div className="grid text-white mt-4 p-3 w-full max-w-sm items-center gap-1.5">
                  <form onSubmit={processVideo}>
                    ...
                    <Input id="something" type="file" />
                    <Button className="bg-white w-full mt-2 text-black font-medium text-base">
                      Detect
                    </Button>
                  </form>
                </div>
